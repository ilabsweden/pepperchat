...
class DialogueModule2(naoqi.ALModule):
    """
...
def main():
    ...
    # variable
    global dialogueModule2
    dialogueModule2 = DialogueModule2(MODULE_NAME, pip)
    dialogueModule2.start()
